<%-- 
    Document   : login
    Created on : Jan 27, 2021, 4:37:09 PM
    Author     : Ray Khum
--%>
        ...
        <div class="signup">
            ...
            <form action="login" method="POST" class="signup-form" autocomplete="off">
                <div class="form-group">
                    <input type="email" class="form-input" placeholder="abc@gmail.com" name="txtEmail" value="${param.txtEmail}" <c:if test="${not empty requestScope.EMAIL}">value="${requestScope.EMAIL}"</c:if>>
                </div>
                <c:if test="${not empty loi}">
                    <font color ="red" size="5%">${loi.emailError}</font>
                </c:if>
                <div class="form-group">
                    <input type="password" class="form-input" placeholder="password" name="txtPassword">
                </div> 
                <c:if test="${not empty loi}">
                    <font color ="red" size="5%">${loi.passwordError}</font>
                </c:if>
                    <font color ="red" size="5%">${requestScope.SAI}</font>
