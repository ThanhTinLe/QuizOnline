<%-- 
    Document   : history
    Created on : Apr 22, 2021, 8:01:47 PM
    Author     : Ray Khum
--%>
...
<html>
    ...
    <body>
        ...
        <c:forEach var="his" items="${sessionScope.LIST_HIS}" varStatus="counter">
            <form action="hisDetail">
                <label>${counter.count}:${his.email} -- day:${his.createDate} -- score:${his.score}</label>
                <button type="submit" name="txtHisID" value="${his.hisID}">view Detail</button>
            </form>
        </c:forEach>
